          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                ...
                <li><i class="ion-ios-arrow-right"></i> <a href="portfolio.php">Partners</a></li>
              </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
              ...
              <p>
                ...
                <strong>Email:</strong> contact@october4world.com <br>
              </p>
<!--Unit – C-03, 14/F, Chiu Tat Factory Building 708-710 Prince Edward Road East San Po Kong, Kowloon. Phone: +852 2259 3330-->
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong>OCTOBER4 LTD</strong>. All Rights Reserved
        </div>
        <div class="credits">
        </div>
      </div>
